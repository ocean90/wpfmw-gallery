...
\begin{thebibliography}{}
   \bibitem[Fancybox]{fancybox} \url{http://fancyapps.com/fancybox/}, 02.09.2013
   \bibitem[Image Carousel]{carousel} \url{http://getbootstrap.com/javascript/#carousel} , 02.09.2013
   \bibitem[Bootstrap]{bootstrap} \url{http://getbootstrap.com} , 26.08.2013
   \bibitem[Facebook]{facebook}    \url{https://developers.facebook.com/docs/reference/plugins/comments/}
