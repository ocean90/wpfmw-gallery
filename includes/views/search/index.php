...
<div id="timeline-page">
	...
	<div class="page-header">
		<?php $search_value = ! empty( $_GET[ 'q' ] ) ? escape_attribute( $_GET[ 'q' ] ) : ''; ?>
		<h2>Search Results <small>Term: <?php echo $search_value; ?></small></h2>
	</div>
	...
	<div class="row">
		<div class="col-md-8">
			...
			if ( empty ( $_[ 'galleries' ]  ) ) {
				echo '<div class="alert alert-warning">No galleries found for this search, yet.</div>';
			} else {
